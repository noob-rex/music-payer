...
img = PhotoImage(file="C:/Users/Prabin/OneDrive/Documents/complete web dev/noob_python/mp3/player ok/best.png", width=500, height=460)
lab = Label(root)
lab.grid()
lab["compound"] = LEFT
lab["image"] = img
...
label_time = Label(root, text="00:00 / 00:00",
                       width=17, font="Helvetica, 10", bg="blue", fg="white")
